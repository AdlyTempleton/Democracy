...
public class RenderCongressman extends RenderLiving {
     ...
     */
    protected int shouldRenderPass(EntityCongressman p_77032_1_, int p_77032_2_, float p_77032_3_)
    {
        return -1;
    }
     ...
     */
    public void doRender(EntityCongressman p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_)
    {
     ...
     */
    protected void preRenderCallback(EntityCongressman p_77041_1_, float p_77041_2_)
    {
        float f1 = 0.9375F;
    ...
    {
        this.doRender((EntityCongressman)p_76986_1_, p_76986_2_, p_76986_4_, p_76986_6_, p_76986_8_, p_76986_9_);
    }
    ...
    {
        this.preRenderCallback((EntityCongressman)p_77041_1_, p_77041_2_);
    }
    ...
    {
        return this.shouldRenderPass((EntityCongressman)p_77032_1_, p_77032_2_, p_77032_3_);
    }

    protected void renderEquippedItems(EntityLivingBase p_77029_1_, float p_77029_2_)
    {
        this.renderEquippedItems((EntityCongressman)p_77029_1_, p_77029_2_);
    }
    ...
    {
        return this.getEntityTexture((EntityCongressman)p_110775_1_);
    }
